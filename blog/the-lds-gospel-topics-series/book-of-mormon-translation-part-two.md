...
[^disregarded]: Whether or not this paradigm shift was the historically accurate
...
[^why-oliver]: I throw Oliver Cowdery in here, and not Emma Smith or Martin
...
[^opportunity]: They are the ones that failed to leave any indication that they
...
[^motive]: Why would they do that? Supposing the church was true. Supposing that
...
[^if-the-church-is-false]: Or I guess if the whole church is false and
...
[^pilgrim]: Emma Smith wrote a letter to Emma Pilgrim talking about how the Urim
...
[^gazelem]: Gerrit Dirkmaat and Micheal Mackay put forth in Let's Talk About the
...
[^martin-harris]: The story from Martin Harris I don't feel like I have a great
...
[^explain-away]: The abridged version: Assuming that the Nephite Interpreters
...
his back, so to say, gave a demonstration of *essentially* how the translation
...
[^not-that-day]: That being said there is a good possibility that I will slip up
...
[^no-real-answer]: Either that or accept my version of it. I do have to say that
...
[^milk-before-meat]: But also as Paul said in 1 Corinthians 3, milk before meat.
...
[^geography]: If they had said "Well it wasn't really the Hill Cumorah, it's the
...
[^and-lack-of-nephite-interpreters]: Jonathan Neville complains a lot about how
...
[^understand]: Numbers 22, God speaks to Balak though his donkey. 1 Samuel 28
...
[^part-one]: See part one of this series:
...
[^seer-stone-cover-up]: Saint Unscripted: Did the Church hide the truth about
...
[^decades]: They are dated from the 1870's and 1880's so it's only two or three
decades after the first pioneers hit Utah in 1847, but still, it's technically
decades.

[^complicated-relationships]: The main sources for the SITH narrative are: Just
...
[^not-grounds-for-dismissal]: Which by itself may not be reason to dismiss them,
...
[^better-grounds-for-dismissal]: For better grounds to dismiss them, if you are
...
[^fly-in-ointment]: One small fly in the ointment is that they occasionally
...
[^why-would-they]: But why would they? The SITH narrative seems to be the
...
[^a-given]: Maybe it wasn't worth mentioning because it was a given? Joseph
...
[^other-answers]: Or imagine if the Urim and Thummim was the chief instrument,
...
[^embarrassed]: But like why? There are a lot of things that Joseph Smith wasn't
...
[^but-which-rock-really]: Though my understanding was that at that point he had
...
[^bh-roberts]: I found it interesting to note that Joseph Fielding Smith cites
...
[^interestingly]: It stands to reason that Lehi and his family knew about the
...
[^d&c130]: I didn't count this one in the list of sources because it doesn't
...
[^urim-and-thummim-not-seer-stone]: Also note that even if we can firmly
...
[^my-interpretation]: I just think that there are too many clarification that
...
[^david-and-emma-didnt-use-urim-and-thummim-for-seer-stone]: A source for this
...
[^compromise]: Which I throw out there not because I believe that, but as a way
...
[^keep-in-mind]: Keep in mind that that could be the true origin of why they
...
[^awkward]: On the other hand, if the Nephite Interpreters exclusive model is
...
[^salamander-letter]: https://en.wikipedia.org/wiki/Salamander_letter It's just
...
and Thummim *and* the Seer Stone). On the other hand, those with opportunity to
...
Essay, *The "Book of Mormon Translation" Essay in Historical Context* by
