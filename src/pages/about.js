    ...
    return (
        <Layout pageTitle="About Me">
            ...
            <p>
                ...
                and president in my local ward. Everything I do—how I see the
                world, what I value, and the way I engage with the world around
                me—is deeply shaped by my faith. The Book of Mormon, in
                particular, holds a special place in my heart, not just for its
                spiritual insights but for its history, translation, and even
                the geographical discussions it sparks.
            </p>
            <p>
